...
<head>
    ...
    <link rel="icon" type="images" href="imgs/logo2.png">
   ...
   <nav class="navbar navbar-expand-lg sticky-top" id="navbar">
    ...
    <div class="container-fluid"> 
      ...
      <div class="col-1" id="navLogo"> 
        <img class="img-fluid" src="imgs/logo2.png" id="logo">
      </div>
    ...
    <li><a class="dropdown-item" href="#">Política de Privacidade e Cookies</a></li>
    <li><a class="dropdown-item" href="#">Plano de contingência Covid-19</a></li>
    </ul>
    </li>
    ...
    <ul class="dropdown-menu animate slideIn">
    <li><a class="dropdown-item" href="#">Berçário e creche</a></li>
    <li><a class="dropdown-item" href="#">Jardim de infância</a></li>
    <li><a class="dropdown-item" href="#">1º Ciclo</a></li>
    <li><a class="dropdown-item" href="#">Centro de Apoio Escolar</a></li>
     ...
     <!-- Educabiz -->
      <div>
        <a href="https://www.educabiz.com/" target="_blank">
          <img src="imgs/educabiz.png" alt="" id="educabiz">
        </a>
      </div>
